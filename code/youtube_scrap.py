...
def scrap_videos():
    ...
    for video in videos:
        ...
        video_items = {'channel_name':channel_name,
...
def scrap_about():
    ...
    try:
        channel_join = driver.find_element_by_xpath('.//*[@id="right-column"]/yt-formatted-string[2]/span[2]').text
    except:
        channel_join = ''

    # Scrap Channel Views (about)
    try:
        channel_views = driver.find_element_by_xpath('.//*[@id="right-column"]/yt-formatted-string[3]').text
    except:
        channel_views=''

    # Scrap Channel Description (about)
    try:
        channel_description = driver.find_element_by_xpath('.//*[@id="description"]').text
    except:
        channel_description=''


    about_items = {'channel_name':channel_name,
...
# export df to csv
df_vids.to_csv('youtube_video_scrap.csv')
